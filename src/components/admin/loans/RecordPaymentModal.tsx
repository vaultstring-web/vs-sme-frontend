...
export default function RecordPaymentModal({ isOpen, onClose, loanId, onSuccess }: RecordPaymentModalProps) {
  const { recordPayment, isLoading, error, clearError } = useLoans();
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <select 
                      ...
                      className="w-full pl-12 pr-4 py-3 rounded-2xl border border-border bg-slate-50 dark:bg-zinc-900 focus:ring-4 focus:ring-primary-500/10 outline-hidden transition-all font-bold appearance-none"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-12 pr-4 py-3 rounded-2xl border border-border bg-slate-50 dark:bg-zinc-900 focus:ring-4 focus:ring-primary-500/10 outline-hidden transition-all font-medium"
                    />
                  </div>
                </div>
